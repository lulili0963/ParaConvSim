...
if __name__ == "__main__":
    ...
    with open(
        "data/cast/year_4/2022_evaluation_topics_flattened_duplicated_v1.0.json"  # noqa
    ) as f:
        topics = json.load(f)

    with open(
        "data/cast/year_4/Year 4 Topic Annotations - User Query Annotations.csv"  # noqa
    ) as csv_file:
    ...
    for topic in topics:
        for turn in topic["turn"]:
            ...
            turn["information_need"] = annotation_dict[turn_id]["information_need"]  # noqa
